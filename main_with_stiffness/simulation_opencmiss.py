...
class Simulation:
    ...
    def forward_solve(self, study_idx, c1):
        ...
        copy('LVWall_ref.part0.exnode', 'ReferenceWall.exnode')
        copy('LVWall_ref.part0.exelem', 'ReferenceWall.exelem')
        copy('LVCavity_ref.part0.exnode', 'ReferenceCavity.exnode')
        copy('LVCavity_ref.part0.exelem', 'ReferenceCavity.exelem')
        mse = []
